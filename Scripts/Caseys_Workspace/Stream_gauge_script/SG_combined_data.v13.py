...
# Function to clean XLSX files (reading 'PT data' sheet)
...
def process_multiple_files(input_directory, start_date, end_date):
    ...
    if all_data:
        ...
        combined_df.drop_duplicates(inplace=True)  # Remove any duplicates
...
if __name__ == "__main__":
    ...
    # Find the correct station folder
